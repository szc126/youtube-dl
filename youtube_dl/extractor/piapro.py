...
class PiaproIE(PiaproBaseInfoExtractor):
	...
	_TESTS = [
		...
		{
			# test 6
			'note': 'Song with lyrics',
			'url': 'https://piapro.jp/t/tNO-',
			'info_dict': {
				'id': '73ovvccjtfulkksu',
			},
			'playlist': [
				{
					'info_dict': {
						'id': '73ovvccjtfulkksu_20131018213243',
						'title': '透明エレジー　4/25リマスタ',
						'formats': list,
						'ext': 'mp3',
						'alt_title': '73ovvccjtfulkksu',
						'display_id': 'tNO-',
						'thumbnails': list,
						'description': 'md5:',
						'uploader': 'n-buna',
						'license': '',
						'timestamp': int, # 20131018213243
						'upload_date': '20131018',
						'uploader_id': 'n_buna',
						'uploader_url': 'https://piapro.jp/n_buna',
						'view_count': int,
						'like_count': int,
						'comment_count': int,
						'webpage_url': 'https://piapro.jp/t/tNO-',
						'categories': ['オンガク', '音楽'],
						'tags': list,
					},
				},
				{
					'info_dict': {
						'id': '8vt9isasneurb9oc_20130220012518',
						'title': '透明エレジー　歌詞',
						'formats': list,
						'ext': 'mp3',
						'alt_title': '8vt9isasneurb9oc',
						'display_id': 'TOlg',
						'thumbnails': list,
						'description': 'md5:',
						'uploader': 'n-buna',
						'license': '',
						'timestamp': int, # 20130220012518
						'upload_date': '20130220',
						'uploader_id': 'n_buna',
						'uploader_url': 'https://piapro.jp/n_buna',
						'view_count': int,
						'like_count': int,
						'comment_count': int,
						'webpage_url': 'https://piapro.jp/t/TOlg',
						'categories': ['テキスト', '歌詞'],
						'tags': list,
					},
				},
			...
			'params': {
				#'skip_download': True,
				#'username': raw_input("[test 6] USERNAME: "),
				#'password': raw_input("[test 6] PASSWORD: "),
			},
		},
		{
			# test 7
			'note': 'Song with lyrics; the lyrics have past versions',
			'url': 'https://piapro.jp/t/LNqz',
			'info_dict': {
				'id': 't0ld0a2dmv98swdl',
			},
			'playlist': [
				{
					'info_dict': {
						'id': 't0ld0a2dmv98swdl_20140219160313',
						'title': 'Scapecoat',
						'formats': list,
						'ext': 'mp3',
						'alt_title': 't0ld0a2dmv98swdl',
						'display_id': 'LNqz',
						'thumbnails': list,
						'description': 'md5:27d410bcfb78de9618ba44b3337928a1',
						'uploader': '鼻そうめんP',
						'license': '非営利目的に限ります\nこの作品を改変しないで下さい\n作者の氏名を表示して下さい',
						'timestamp': int, # 20140219160313
						'upload_date': '20140219',
						'uploader_id': 'tabg',
						'uploader_url': 'https://piapro.jp/tabg',
						'view_count': int,
						'like_count': int,
						'comment_count': int,
						'webpage_url': 'https://piapro.jp/t/LNqz',
						'categories': ['オンガク', '音楽'],
						'tags': list,
					},
				},
				{
					'info_dict': {
						'id': 'hfw0s8t8ivtnpfnl_20130812125850',
						'title': 'scapecoat',
						'formats': list,
						'ext': 'jpg',
						'alt_title': 'hfw0s8t8ivtnpfnl',
						'display_id': 'uheG',
						'thumbnails': list,
						'description': 'md5:',
						'uploader': 'chu-ji',
						'license': '非営利目的に限ります\nこの作品を改変しないで下さい\n作者の氏名を表示して下さい',
						'timestamp': int, # 20130812125850
						'upload_date': '20130812',
						'uploader_id': 'transient1710',
						'uploader_url': 'https://piapro.jp/transient1710',
						'view_count': int,
						'like_count': int,
						'comment_count': int,
						'webpage_url': 'https://piapro.jp/t/uheG',
						'categories': ['テキスト', '歌詞'],
						'tags': list,
					},
				},
				{
					'info_dict': {
						'id': 'hfw0s8t8ivtnpfnl_20130725222526',
						'title': 'scapecoat',
						'formats': list,
						'ext': 'jpg',
						'alt_title': 'hfw0s8t8ivtnpfnl',
						...
						'uploader': 'chu-ji',
						'license': '非営利目的に限ります\nこの作品を改変しないで下さい\n作者の氏名を表示して下さい',
						'timestamp': int, # 20130725222526
						'upload_date': '20130725',
						'uploader_id': 'transient1710',
						'uploader_url': 'https://piapro.jp/transient1710',
						'view_count': int,
						'like_count': int,
				...
				{
					'info_dict': {
						'id': 'hfw0s8t8ivtnpfnl_20130719073429',
						'title': 'scapecoat',
						'formats': list,
						'ext': 'jpg',
						'alt_title': 'hfw0s8t8ivtnpfnl',
						...
						'uploader': 'chu-ji',
						'license': '非営利目的に限ります\nこの作品を改変しないで下さい\n作者の氏名を表示して下さい',
						'timestamp': int, # 20130719073429
						'upload_date': '20130719',
						'uploader_id': 'transient1710',
						'uploader_url': 'https://piapro.jp/transient1710',
						'view_count': int,
						'like_count': int,
			...
			'params': {
				#'skip_download': True,
				#'username': raw_input("[test 7] USERNAME: "),
				#'password': raw_input("[test 7] PASSWORD: "),
			},
		},
		{
			'only_matching': True,
